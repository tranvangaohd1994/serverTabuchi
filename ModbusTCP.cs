...
namespace Server
{
    ...
    {
        //////////////////////////////////////////////////////////////////////////////
        //PHAN NAY LA KhAI BAO THEM DE PHU HOP VOI CHUONG TRINH QUAN LY CUA DU AN
        //////////////////////////////////////////////////////////////////////////////
        //IP address
        public string IP_address = "";
        //RS cho tung line 
        public string[] RS = new string[] { "False", "False", "False", "False", "False", "False", "False" };
        public string[] RS_Stock = new string[] { "False" };
        //Intime cho tung line
        public bool[] Intime = new bool[] { false, false, false, false, false, false, false };
        public bool[] Intime_Stock = new bool[] { false };
        //STATUS cho 7 line
        public int[] Status = new int[] { 0, 0, 0, 0, 0, 0, 0 };
        public int[] Status_Stock = new int[] { 0 };
        //ACTUAL cho 7 line
        public int[] Actual = new int[] { 0, 0, 0, 0, 0, 0, 0 };
        public uint[] Actual_Stock = new uint[] { 0 };
        //PlAN cho 7 line
        public int[] Plan = new int[] { 0, 0, 0, 0, 0, 0, 0 };
        public uint[] Plan_Stock = new uint[] { 0 };
        //TACT TIME cho 7 line
        public uint[] Tact_time = new uint[] { 0, 0, 0, 0, 0, 0, 0 };
        public uint[] Tact_time_Stock = new uint[] { 0 };
        //TARGET cho 7 line
        public int[] Target = new int[] { 0, 0, 0, 0, 0, 0, 0 };
        public uint[] Target_Stock = new uint[] { 0 };
        //DIFF  cho 7 line
        public int[] Diff = new int[] { 0, 0, 0, 0, 0, 0, 0 };
        public int[] Diff_Stock = new int[] { 0 };
        //trang thai cho ket noi
        public bool M_connected = false;
        //thong bao hoan thanh qua trinh connect (ke ca that bai)
        public bool connect_done = false;
        //////////////////////////////////////////////////////////////////////////////
        //KET THUC KHAI BAO THEM
        //////////////////////////////////////////////////////////////////////////////
        // ------------------------------------------------------------------------
        ...
        public delegate void ExceptionData(ushort id, byte unit, byte function, byte exception, string IP_address);
        /// <summary>Exception data event. This event is called when the data is incorrect</summary>
        ...
        internal void CallException(ushort id, byte unit, byte function, byte exception)
        {
            ...
            if (OnException != null) OnException(id, unit, function, exception, IP_address);
        }
